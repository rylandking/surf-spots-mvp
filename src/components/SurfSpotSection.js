...
export default function SurfSpotSection({
    ...
    return (
        <div>
            ...
            <p class="mb-2">Get Google Maps <a href="https://www.google.com/maps?saddr=My+Location&daddr="{surfSpotLat}","{surfSpotLng} target="blank">directions to {titleContraction} surf parking lot.</a></p>
        </div >
    )
}