...
export default function PostLayout(props) {
    ...
    let directionsLink = `https://www.google.com/maps?saddr=My+Location&daddr=${surfSpotLat},-76.12345`
    ...
    let jan = page.jan.value;
    let feb = page.feb.value;
    let mar = page.mar.value;
    let apr = page.apr.value;
    let may = page.may.value;
    let jun = page.jun.value;
    let jul = page.jul.value;
                ...
                <article className="colors-a px-4 sm:px-8 py-14 lg:py-20">
                    <div className="max-w-screen-2xl mx-auto">
                        ...
                        <SurfSpotSection
                            ...
                            surfSpotLng={surfSpotLat}
                            surfSpotLat={surfSpotLng}
                        />
