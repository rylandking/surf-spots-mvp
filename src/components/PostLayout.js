...
export default function PostLayout(props) {
    ...
    let waveType = JSON.stringify(page.waveType.value)
            ...
            <main id="main" className="sb-layout sb-post-layout">
                <article className="colors-a px-4 sm:px-8 py-14 lg:py-20">
                    <div className="max-w-screen-2xl mx-auto">
                        ...
                        <SurfSpotSection titleContraction={titleContraction} skillPhrase={skillPhrase} waveDirection={waveDirection} waveType={waveType} />
